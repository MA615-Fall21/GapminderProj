...
from highest median literacy rate to lowest median literacty rate. This plot 
...
where there is a high literacy rate, there are stil countries with high poverty 
rates. 
